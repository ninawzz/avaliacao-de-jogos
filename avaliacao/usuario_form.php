            ...
            <div class="col-md-3 col-lg-4 d-flex align-items-center">
                <div class="card-body p-3"> 
                    ...
                    <div class="d-flex mb-2 pb-1">
                        <span class="h3 fw-bold mb-0">Cadastro</span> 
                    </div>
                    ...
                    <div class="pt-1 mb-3"><button type="submit" class="btn btn-cadastrar btn-sm w-100">Cadastrar</button></div>

                    <a href="index.php" class="btn btn-volta w-100 mb-1 btn-sm">Voltar</a>
                    <a href="form_login.php" class="text-white w-100 small">Já tem uma conta? entre aqui</a>
